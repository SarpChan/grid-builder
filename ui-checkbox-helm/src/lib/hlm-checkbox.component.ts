...
export class HlmCheckboxComponent {
  ...
  protected _computedClass = computed(() =>
    hlm(
      'group inline-flex border border-accent shrink-0 cursor-pointer items-center rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring' +
